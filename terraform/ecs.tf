...
####################################################
locals {
  ecr_frontend_repository_name           = "${local.app_name}-next"
  ecr_backend_middleware_repository_name = "${local.app_name}-nginx"
  ecr_backend_app_repository_name        = "${local.app_name}-phpfpm"
}
...
locals {
  ...
  backend_task_app_container_name        = "${local.app_name}-app-container-phpfpm-backend"
}
